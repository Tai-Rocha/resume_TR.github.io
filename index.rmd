...
```{r}
 if(params$pdf_mode){
  cat("<i class='fas fa-download'></i> [CV online disponível]https://tai-rocha.github.io/TR_CV_PT.github.io/)")
  } else {
  cat("[Versão PDF disponível](https://github.com/Tai-Rocha/resume_TR.github.io/raw/main/TR_resume_pt.pdf)")
}
```
